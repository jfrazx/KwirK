...
export module Constants {
  ...
  /**
  * @note Many IRC Constants definitions pilfered from Cinch
  */
 ...
 export enum IRC {
  ...
  export enum HTTP {
    ...
    "Expectation Failure" = 417,
    "I'm a teapot" = 418,
    "Authentication Timeout" = 419,
    "Enhance Your Calm" = 420,
    "Misdirected Redirect" = 421,
    ...
    "Unknown Error" = 520,
    "Origin Connection Time-out" = 522,
