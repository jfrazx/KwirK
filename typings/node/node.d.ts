...
declare module "fs" {
  ...
  export function write(fd: number, data: any, position: number, encoding: string, callback?: (err: NodeJS.ErrnoException, written: number, buffer: Buffer) => void): void;
  export function write(fd: number, data: any, encoding: string, callback?: (err: NodeJS.ErrnoException, written: number, buffer: Buffer) => void): void;
  export function write(fd: number, data: any, position: number, callback?: (err: NodeJS.ErrnoException, written: number, buffer: Buffer) => void): void;
  export function write(fd: number, data: any, callback?: (err: NodeJS.ErrnoException, written: number, buffer: Buffer) => void): void;
...
declare module "tls" {
  ...
  export interface TLSSocket extends net.Socket {
    encrypted: boolean;
    authorized: boolean;
    ...
    renegotiate(options: { rejectUnauthorized?: boolean, requestCert?: boolean }, callback: Function): void;
  ...
  export var TLSSocket: {
    new (socket: net.Socket, options: TLSSocketOptions): TLSSocket;
  }

  export var Server: {
    new (port: number, host?: string, backlog?: number, callback?: Function): Server;
  }
  ...
  export function connect(port: number, options?: ConnectionOptions, secureConnectListener?: () => void): ClearTextStream | TLSSocket;
